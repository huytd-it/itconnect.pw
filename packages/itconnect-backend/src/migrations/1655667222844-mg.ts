...
export class mg1655667222844 implements MigrationInterface {
    name = 'mg1655667222844'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`skill_entity\` DROP COLUMN \`userSkillsId\``);
        await queryRunner.query(`ALTER TABLE \`job_level_entity\` DROP COLUMN \`userInfosId\``);
        await queryRunner.query(`ALTER TABLE \`position_entity\` DROP COLUMN \`userPositionsId\``);
        await queryRunner.query(`ALTER TABLE \`user_info_entity\` ADD \`jobLevelId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`position_entity\` ADD \`userPositionsId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`job_level_entity\` ADD \`userInfosId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`skill_entity\` ADD \`userSkillsId\` int NULL DEFAULT 'NULL'`);
