...
export class mg1655983659913 implements MigrationInterface {
    name = 'mg1655983659913'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user_info_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`addressStreet\` varchar(255) NOT NULL, \`phone\` varchar(255) NULL, \`fullName\` varchar(255) NOT NULL, \`birthday\` datetime NOT NULL, \`computeYoe\` int NULL, \`computeYoeDate\` datetime NULL, \`computeYoeCurrent\` tinyint NULL, \`interest\` text NULL, \`objective\` text NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`addressProvinceId\` int NULL, \`addressDistrictId\` int NULL, \`addressVillageId\` int NULL, \`jobLevelId\` int NULL, UNIQUE INDEX \`REL_9c391e2018f807b6843cdee35c\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`cv_education_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`mark\` float NULL, \`content\` text NULL, \`startDate\` datetime NOT NULL, \`endDate\` datetime NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`rankedAcademicId\` int NULL, \`schoolId\` int NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`job_certificate_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`levelMin\` int NOT NULL DEFAULT '1', \`levelMax\` int NOT NULL DEFAULT '10', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`certificateId\` int NULL, UNIQUE INDEX \`IDX_b7cf5d8ef87d90d475e27b6025\` (\`certificateId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`addressStreet\` varchar(255) NOT NULL, \`salaryMin\` int NOT NULL, \`salaryMax\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`endDate\` datetime NOT NULL, \`descriptionContent\` varchar(255) NOT NULL, \`requirementContent\` varchar(255) NOT NULL, \`reasonContent\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`addressProvinceId\` int NULL, \`addressDistrictId\` int NULL, \`addressVillageId\` int NULL, \`companyTagId\` int NULL, \`jobLevelId\` int NULL, UNIQUE INDEX \`REL_41535e84680fcc7f28198e6afe\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job_position_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`levelMin\` int NOT NULL DEFAULT '1', \`levelMax\` int NOT NULL DEFAULT '10', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`positionId\` int NULL, UNIQUE INDEX \`IDX_6f8ef2e25f2fbc1c6b9eb4cbd6\` (\`positionId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job_work_from_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`levelMin\` int NOT NULL DEFAULT '1', \`levelMax\` int NOT NULL DEFAULT '10', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`workFromId\` int NULL, UNIQUE INDEX \`IDX_23216481bb8cef86d46c02143a\` (\`workFromId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job_skill_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`levelMin\` int NOT NULL DEFAULT '1', \`levelMax\` int NOT NULL DEFAULT '10', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`skillId\` int NULL, UNIQUE INDEX \`IDX_c3a1d3a81507c26284a0d47117\` (\`skillId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`job_school_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`levelMin\` int NOT NULL DEFAULT '1', \`levelMax\` int NOT NULL DEFAULT '10', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` int NULL, \`schoolId\` int NULL, UNIQUE INDEX \`IDX_bf9fba891fb911752be0d410d4\` (\`schoolId\`, \`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_certificate_entity\` ADD CONSTRAINT \`FK_9efc37be41266b6777ef1ff698b\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_entity\` ADD CONSTRAINT \`FK_41535e84680fcc7f28198e6afec\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`job_entity\` ADD CONSTRAINT \`FK_33edaf7acfa16ebb75737687164\` FOREIGN KEY (\`addressProvinceId\`) REFERENCES \`address_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_entity\` ADD CONSTRAINT \`FK_2c38966cedacd716055cb5cb8a8\` FOREIGN KEY (\`jobLevelId\`) REFERENCES \`job_level_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`job_position_entity\` ADD CONSTRAINT \`FK_ba0bb0fa62857ffc7be43b03ecb\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_work_from_entity\` ADD CONSTRAINT \`FK_fc5b32f43c332f03509b0ab40b1\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`job_work_from_entity\` ADD CONSTRAINT \`FK_d13b6cb2d1e8a2ca5aed7a3c939\` FOREIGN KEY (\`workFromId\`) REFERENCES \`work_from_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`job_skill_entity\` ADD CONSTRAINT \`FK_c1a0cf7ab4d7bd96f444d0e3cc1\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_school_entity\` ADD CONSTRAINT \`FK_06309bb8a51c836d3230342513d\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`job_school_entity\` DROP FOREIGN KEY \`FK_06309bb8a51c836d3230342513d\``);
        await queryRunner.query(`ALTER TABLE \`job_skill_entity\` DROP FOREIGN KEY \`FK_123bc46f5a98eaad8e083f655eb\``);
        await queryRunner.query(`ALTER TABLE \`job_skill_entity\` DROP FOREIGN KEY \`FK_c1a0cf7ab4d7bd96f444d0e3cc1\``);
        await queryRunner.query(`ALTER TABLE \`job_work_from_entity\` DROP FOREIGN KEY \`FK_d13b6cb2d1e8a2ca5aed7a3c939\``);
        await queryRunner.query(`ALTER TABLE \`job_work_from_entity\` DROP FOREIGN KEY \`FK_fc5b32f43c332f03509b0ab40b1\``);
        await queryRunner.query(`ALTER TABLE \`job_position_entity\` DROP FOREIGN KEY \`FK_0d6c53d3773e6fc2bc58f5d8ee6\``);
        await queryRunner.query(`ALTER TABLE \`job_position_entity\` DROP FOREIGN KEY \`FK_ba0bb0fa62857ffc7be43b03ecb\``);
        await queryRunner.query(`ALTER TABLE \`job_entity\` DROP FOREIGN KEY \`FK_2c38966cedacd716055cb5cb8a8\``);
        ...
        await queryRunner.query(`ALTER TABLE \`job_entity\` DROP FOREIGN KEY \`FK_33edaf7acfa16ebb75737687164\``);
        await queryRunner.query(`ALTER TABLE \`job_entity\` DROP FOREIGN KEY \`FK_41535e84680fcc7f28198e6afec\``);
        await queryRunner.query(`ALTER TABLE \`job_certificate_entity\` DROP FOREIGN KEY \`FK_cc2fa255984afb0caf06adb894b\``);
        await queryRunner.query(`ALTER TABLE \`job_certificate_entity\` DROP FOREIGN KEY \`FK_9efc37be41266b6777ef1ff698b\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_bf9fba891fb911752be0d410d4\` ON \`job_school_entity\``);
        await queryRunner.query(`DROP TABLE \`job_school_entity\``);
        await queryRunner.query(`DROP INDEX \`IDX_c3a1d3a81507c26284a0d47117\` ON \`job_skill_entity\``);
        await queryRunner.query(`DROP TABLE \`job_skill_entity\``);
        await queryRunner.query(`DROP INDEX \`IDX_23216481bb8cef86d46c02143a\` ON \`job_work_from_entity\``);
        await queryRunner.query(`DROP TABLE \`job_work_from_entity\``);
        await queryRunner.query(`DROP INDEX \`IDX_6f8ef2e25f2fbc1c6b9eb4cbd6\` ON \`job_position_entity\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_b7cf5d8ef87d90d475e27b6025\` ON \`job_certificate_entity\``);
