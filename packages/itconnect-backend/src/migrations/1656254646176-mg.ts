...
export class mg1656254646176 implements MigrationInterface {
    name = 'mg1656254646176'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`ranked_academic_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, UNIQUE INDEX \`IDX_7249094a488abcd488f73befca\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`job_job_level_entity\` ADD CONSTRAINT \`FK_ee0dd8f1261d8e50f9fa7c96760\` FOREIGN KEY (\`jobId\`) REFERENCES \`job_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`job_job_level_entity\` ADD CONSTRAINT \`FK_2213a20f845ac0d12bc8bb51d03\` FOREIGN KEY (\`jobLevelId\`) REFERENCES \`job_level_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`job_job_level_entity\` DROP FOREIGN KEY \`FK_2213a20f845ac0d12bc8bb51d03\``);
        await queryRunner.query(`ALTER TABLE \`job_job_level_entity\` DROP FOREIGN KEY \`FK_ee0dd8f1261d8e50f9fa7c96760\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_bda60d0d004350f56667d8f4bf\` ON \`job_work_from_entity\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_7249094a488abcd488f73befca\` ON \`ranked_academic_entity\``);
