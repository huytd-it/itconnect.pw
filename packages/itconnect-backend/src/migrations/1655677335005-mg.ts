...
export class mg1655677335005 implements MigrationInterface {
    name = 'mg1655677335005'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user_info_entity\` DROP FOREIGN KEY \`FK_e7b0e7181fd855f9f1e812e592b\``);
        await queryRunner.query(`DROP INDEX \`IDX_9c391e2018f807b6843cdee35c\` ON \`user_info_entity\``);
        await queryRunner.query(`DROP INDEX \`IDX_bbd7576066b053fc16f76617e0\` ON \`company_info_entity\``);
        await queryRunner.query(`CREATE TABLE \`cv_sec_control_data_position_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`level\` int NOT NULL DEFAULT '1', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`cvSecControlDataId\` int NULL, \`positionId\` int NULL, \`userId\` int NULL, INDEX \`IDX_ef831fac1c2fcd4ef14dd3745d\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`cv_sec_control_data_job_level_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`level\` int NOT NULL DEFAULT '1', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`cvSecControlDataId\` int NULL, \`jobLevelId\` int NULL, \`userId\` int NULL, INDEX \`IDX_d2f6c1d19b78d328522e88021a\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`cv_sec_control_data_work_from_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`level\` int NOT NULL DEFAULT '1', \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`cvSecControlDataId\` int NULL, \`workFromId\` int NULL, \`userId\` int NULL, INDEX \`IDX_bac6c34f5a6cba6cfc7faea7e0\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`user_info_entity\` DROP COLUMN \`jobLevelId\``);
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`cvSecControlDataId\` \`cvSecControlDataId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`skillId\` \`skillId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`userId\` \`userId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_position_entity\` ADD CONSTRAINT \`FK_1930a6f40e37381e0b88dacf484\` FOREIGN KEY (\`cvSecControlDataId\`) REFERENCES \`cv_sec_control_data_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_position_entity\` ADD CONSTRAINT \`FK_56f230f4f661030a6673d63dff3\` FOREIGN KEY (\`positionId\`) REFERENCES \`position_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_position_entity\` ADD CONSTRAINT \`FK_bcbe34b54e8ae2e347f1e90a767\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_job_level_entity\` ADD CONSTRAINT \`FK_b6ccbeb68ea642d899e3d33d070\` FOREIGN KEY (\`cvSecControlDataId\`) REFERENCES \`cv_sec_control_data_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_job_level_entity\` ADD CONSTRAINT \`FK_466c2e60ed7a5fc4790ccb63305\` FOREIGN KEY (\`jobLevelId\`) REFERENCES \`job_level_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_job_level_entity\` ADD CONSTRAINT \`FK_8d746b9c38a46057b2685c40f44\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_work_from_entity\` ADD CONSTRAINT \`FK_ac104228bcd11ae53c5721f4cbc\` FOREIGN KEY (\`cvSecControlDataId\`) REFERENCES \`cv_sec_control_data_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_work_from_entity\` ADD CONSTRAINT \`FK_ebbd0eecc748fa5c12d4832a57b\` FOREIGN KEY (\`workFromId\`) REFERENCES \`work_from_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_work_from_entity\` ADD CONSTRAINT \`FK_a99020b18e533effef18dfe6b54\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_section_control_type_entity\` DROP FOREIGN KEY \`FK_dddd91861299432578ea49ccb59\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP FOREIGN KEY \`FK_7c99c304cf66aeed6e382e352cc\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_work_from_entity\` DROP FOREIGN KEY \`FK_a99020b18e533effef18dfe6b54\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_work_from_entity\` DROP FOREIGN KEY \`FK_ebbd0eecc748fa5c12d4832a57b\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_work_from_entity\` DROP FOREIGN KEY \`FK_ac104228bcd11ae53c5721f4cbc\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_job_level_entity\` DROP FOREIGN KEY \`FK_8d746b9c38a46057b2685c40f44\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_job_level_entity\` DROP FOREIGN KEY \`FK_466c2e60ed7a5fc4790ccb63305\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_job_level_entity\` DROP FOREIGN KEY \`FK_b6ccbeb68ea642d899e3d33d070\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_position_entity\` DROP FOREIGN KEY \`FK_bcbe34b54e8ae2e347f1e90a767\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_position_entity\` DROP FOREIGN KEY \`FK_56f230f4f661030a6673d63dff3\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_position_entity\` DROP FOREIGN KEY \`FK_1930a6f40e37381e0b88dacf484\``);
        await queryRunner.query(`ALTER TABLE \`user_position_entity\` DROP FOREIGN KEY \`FK_8f6fff6b2239738702560ddb52b\``);
        await queryRunner.query(`ALTER TABLE \`user_position_entity\` DROP FOREIGN KEY \`FK_4bb7b007ab6347dad742d533715\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` DROP FOREIGN KEY \`FK_eddcdcd1f30d7693ac5e00b86fe\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` DROP FOREIGN KEY \`FK_d31c5b86f25b51b4f2e7c17e7ab\``);
        ...
        await queryRunner.query(`ALTER TABLE \`user_position_entity\` ADD CONSTRAINT \`FK_8f6fff6b2239738702560ddb52b\` FOREIGN KEY (\`positionId\`) REFERENCES \`position_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`user_position_entity\` ADD CONSTRAINT \`FK_4bb7b007ab6347dad742d533715\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`skillId\` \`skillId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`cvSecControlDataId\` \`cvSecControlDataId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` CHANGE \`deletedAt\` \`deletedAt\` datetime(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` ADD CONSTRAINT \`FK_eddcdcd1f30d7693ac5e00b86fe\` FOREIGN KEY (\`userId\`) REFERENCES \`user_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` ADD CONSTRAINT \`FK_d31c5b86f25b51b4f2e7c17e7ab\` FOREIGN KEY (\`skillId\`) REFERENCES \`skill_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_skill_entity\` ADD CONSTRAINT \`FK_86d87fbcd5cf6391e56ebebd880\` FOREIGN KEY (\`cvSecControlDataId\`) REFERENCES \`cv_sec_control_data_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_info_entity\` ADD \`jobLevelId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`DROP INDEX \`IDX_bac6c34f5a6cba6cfc7faea7e0\` ON \`cv_sec_control_data_work_from_entity\``);
        await queryRunner.query(`DROP TABLE \`cv_sec_control_data_work_from_entity\``);
        await queryRunner.query(`DROP INDEX \`IDX_d2f6c1d19b78d328522e88021a\` ON \`cv_sec_control_data_job_level_entity\``);
        await queryRunner.query(`DROP TABLE \`cv_sec_control_data_job_level_entity\``);
        await queryRunner.query(`DROP INDEX \`IDX_ef831fac1c2fcd4ef14dd3745d\` ON \`cv_sec_control_data_position_entity\``);
        await queryRunner.query(`DROP TABLE \`cv_sec_control_data_position_entity\``);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_bbd7576066b053fc16f76617e0\` ON \`company_info_entity\` (\`userId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_9c391e2018f807b6843cdee35c\` ON \`user_info_entity\` (\`userId\`)`);
