...
export class mg1655674739850 implements MigrationInterface {
    name = 'mg1655674739850'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_2c29405d2b0a1d971d15f62e369\` ON \`cv_sec_control_data_entity\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_2c29405d2b0a1d971d15f62e369\` ON \`cv_sec_control_data_entity\` (\`cvSecDataId\`)`);
    }
