...
export class mg1655673762990 implements MigrationInterface {
    name = 'mg1655673762990'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` ADD \`tag_name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` ADD UNIQUE INDEX \`IDX_4fb5f1bf1f21b237b07571cfa6\` (\`tag_name\`)`);
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` CHANGE \`cvSecDataId\` \`cvSecDataId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` CHANGE \`cvSecDataId\` \`cvSecDataId\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`address_entity\` ADD CONSTRAINT \`FK_d96e5f9914d0f80c787b8da289b\` FOREIGN KEY (\`parentId\`) REFERENCES \`address_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP INDEX \`IDX_4fb5f1bf1f21b237b07571cfa6\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP COLUMN \`tag_name\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` ADD \`userId\` int NULL DEFAULT 'NULL'`);
