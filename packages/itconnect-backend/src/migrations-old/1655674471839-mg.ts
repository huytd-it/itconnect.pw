...
export class mg1655674471839 implements MigrationInterface {
    name = 'mg1655674471839'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` DROP FOREIGN KEY \`FK_2c29405d2b0a1d971d15f62e369\``);
        await queryRunner.query(`DROP INDEX \`IDX_4fb5f1bf1f21b237b07571cfa6\` ON \`cv_sec_builder_entity\``);
        await queryRunner.query(`DROP INDEX \`tag_name_unique\` ON \`cv_sec_builder_entity\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` CHANGE \`cvSecDataId\` \`cvSecDataRowId\` int NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP COLUMN \`tag_name\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_section_control_type_entity\` ADD \`cvControlSelectTypeId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` ADD \`tag\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` ADD UNIQUE INDEX \`IDX_2a677367934db9d4761a0b1dcc\` (\`tag\`)`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` ADD \`max_data_row\` int NOT NULL DEFAULT '1'`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`tag_unique\` ON \`cv_sec_builder_entity\` (\`tag\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`address_entity\` ADD CONSTRAINT \`FK_d96e5f9914d0f80c787b8da289b\` FOREIGN KEY (\`parentId\`) REFERENCES \`address_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP COLUMN \`max_data_row\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP INDEX \`IDX_2a677367934db9d4761a0b1dcc\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` DROP COLUMN \`tag\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_section_control_type_entity\` DROP COLUMN \`cvControlSelectTypeId\``);
        await queryRunner.query(`ALTER TABLE \`cv_sec_builder_entity\` ADD \`tag_name\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`cv_sec_control_data_entity\` CHANGE \`cvSecDataRowId\` \`cvSecDataId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`tag_name_unique\` ON \`cv_sec_builder_entity\` (\`tag_name\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_4fb5f1bf1f21b237b07571cfa6\` ON \`cv_sec_builder_entity\` (\`tag_name\`)`);
